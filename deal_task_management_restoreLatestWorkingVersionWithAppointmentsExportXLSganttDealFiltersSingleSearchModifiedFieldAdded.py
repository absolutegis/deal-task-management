...
if uploaded_files and len(uploaded_files) == 2:
    try:
        ...
        with pd.ExcelWriter(buffer, engine='xlsxwriter') as writer:
            ...
            tasks_df[['Start Date', 'Due Date', 'Modified On']] = tasks_df[['Start Date', 'Due Date', 'Modified On']].apply(lambda x: pd.to_datetime(x, errors='coerce').dt.date)
